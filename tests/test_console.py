...
class TestHBNBCommand_prompting(unittest.TestCase):
    """Unittests for testing prompting of the HBNB cmand interpreter."""
    ...
    def test_pep8_console(self):
        ...
        ers = 0
        file = (["console.py"])
        ers += pep_style.check_files(file).total_errors
        self.assertEqual(ers, 0, 'Need to fix Pep8')
...
class TestHBNBCommand_help(unittest.TestCase):
    """Unittests for testing help messages of the HBNB cmand interpreter."""

    def test_help_quit(self):
        hlp = "Quit cmand to exit the program"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(hlp, output.getvalue().strip())

    def test_help_create(self):
        hlp = ("Create instance specified by user")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_show(self):
        hlp = ("Print string repr of a class instance, given id")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help show"))
            self.assertEqual(hlp, output.getvalue().strip())

    def test_help_destroy(self):
        hlp = ("Delete a class instance of a given id, save result"
             " to json file")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_all(self):
        hlp = ("Prints all string representation of all instances based or"
    ...
    def test_help_count(self):
        hlp = ("Display count of instances specified")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help count"))
            self.assertEqual(hlp, output.getvalue().strip())

    def test_help_update(self):
        hlp = ("Updates an instance based on the class name and id by adding"
...
class TestHBNBCommand_exit(unittest.TestCase):
    """Unittests for testing exiting from the HBNB cmand interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Unittests for testing create from the HBNB cmand interpreter."""
    ...
    def test_create_missing_class(self):
        correct_chk = "** class name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(correct_chk, output.getvalue().strip())

    def test_create_invalid_class(self):
        correct_chk = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(correct_chk, output.getvalue().strip())

    def test_create_invalid_syntax(self):
        correct_chk = "*** Unknown syntax: MyModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.create()"))
            self.assertEqual(correct_chk, output.getvalue().strip())
        correct_chk = "*** Unknown syntax: BaseModel.create()"
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_show(unittest.TestCase):
    """Unittests for testing show from the HBNB cmand interpreter"""
    ...
    def test_show_missing_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(".show()"))
            self.assertNotEqual(correct_chk, output.getvalue().strip())
    ...
    def test_show_missing_id_space_notation(self):
        correct_chk = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            cmand = "show BaseModel {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            cmand = "show State {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            cmand = "show Place {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            cmand = "show Amenity {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            cmand = "show Review {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
    ...
    def test_show_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(testID)]
            cmand = "BaseModel.show({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["State.{}".format(testID)]
            cmand = "State.show({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(testID)]
            cmand = "Place.show({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Amenity.{}".format(testID)]
            cmand = "Amenity.show({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(testID)]
            cmand = "Review.show({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertEqual(obj.__str__(), output.getvalue().strip())


class TestHBNBCommand_destroy(unittest.TestCase):
    """Unittests for testing destroy from the HBNB cmand interpreter."""
    ...
    def test_destroy_objects_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(testID)]
            cmand = "destroy BaseModel {}".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
    ...
    def test_destroy_objects_dot_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["BaseModel.{}".format(testID)]
            cmand = "BaseModel.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["User.{}".format(testID)]
            cmand = "User.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["State.{}".format(testID)]
            cmand = "State.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Place.{}".format(testID)]
            cmand = "Place.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["City.{}".format(testID)]
            cmand = "City.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Amenity.{}".format(testID)]
            cmand = "Amenity.destroy({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Review"))
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            obj = storage.all()["Review.{}".format(testID)]
            cmand = "Review.destory({})".format(testID)
            self.assertFalse(HBNBCommand().onecmd(cmand))
            self.assertNotIn(obj, storage.all())


class TestHBNBCommand_all(unittest.TestCase):
    """Unittests for testing all of the HBNB cmand interpreter."""
...
class TestHBNBCommand_update(unittest.TestCase):
    """Unittests for testing update from the HBNB cmand interpreter."""
    ...
    def test_update_missing_attr_name_space_notation(self):
        correct_chk = "** attribute name missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testinId = output.getvalue().strip()
            testinCmd = "update BaseModel {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create User"))
            testinId = output.getvalue().strip()
            testinCmd = "update User {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create State"))
            testinId = output.getvalue().strip()
            testinCmd = "update State {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
            testinId = output.getvalue().strip()
            testinCmd = "update City {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testinId = output.getvalue().strip()
            testinCmd = "update Amenity {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Place"))
            testinId = output.getvalue().strip()
            testinCmd = "update Place {}".format(testinId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())

    def test_update_missing_attr_value_space_notation(self):
        correct_chk = "** value missing **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update BaseModel {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update User {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update State {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update City {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update Amenity {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update Place {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            testinId = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
            testinCmd = "update Review {} attr_name".format(testinId)
            self.assertFalse(HBNBCommand().onecmd(testinCmd))
            self.assertEqual(correct_chk, output.getvalue().strip())
    ...
    def test_update_valid_string_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testinId = output.getvalue().strip()
        testinCmd = "update BaseModel {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["BaseModel.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create User")
            testinId = output.getvalue().strip()
        testinCmd = "update User {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["User.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create State")
            testinId = output.getvalue().strip()
        testinCmd = "update State {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["State.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create City")
            testinId = output.getvalue().strip()
        testinCmd = "update City {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["City.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testinId = output.getvalue().strip()
        testinCmd = "update Place {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["Place.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Amenity")
            testinId = output.getvalue().strip()
        testinCmd = "update Amenity {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["Amenity.{}".format(testinId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Review")
            testinId = output.getvalue().strip()
        testinCmd = "update Review {} attr_name 'attr_value'".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["Review.{}".format(testinId)].__dict__
    ...
    def test_update_valid_float_attr_space_notation(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testinId = output.getvalue().strip()
        testinCmd = "update Place {} latitude 7.2".format(testinId)
        self.assertFalse(HBNBCommand().onecmd(testinCmd))
        test_dict = storage.all()["Place.{}".format(testinId)].__dict__
