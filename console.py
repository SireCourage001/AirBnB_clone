...
class HBNBCommand(cmd.Cmd):
    """
    Summation: class that defines command interpreter.
    """
    ...
    def emptyline(self):
        """An empty line + ENTER should NOT execute anything
           ...
           the method was modified because default
    ...
    def do_create(self, arg):
        """Creates a new instance of BaseModel and save it to
        JSON file therefter print id.
        """
    ...
    def do_show(self, arg):
        ...
        if args_list[0] == "":
            ...
            """Checks if the 'id' exists. To do so we need to
            ...
            if id_object not in storage.all():
                ...
                """print the str representation based on the
    ...
    def do_count(self, arg):
        """Count the num of instances of a class"""
        count = 0
        for key, value in storage.all().items():
            if key.split(".")[0] == arg:
                count += 1
